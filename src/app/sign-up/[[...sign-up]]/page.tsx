    ...
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-start gap-6">
          ...
          <div>
            <div className="font-bakbak text-[40px] leading-[1.1] text-[#f4ecdc]">
              JOIN THE<br />MOODI<br />GANG
            </div>
            <div className="mt-4 font-anek text-[16px] text-[#c4b79c]">
              உங்கள் mood-க்கு ஏத்த poster கிடைக்கும்.
            </div>
          </div>
        </div>
